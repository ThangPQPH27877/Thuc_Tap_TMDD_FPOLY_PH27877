package com.example.thuc_tap_tmdd_fpoly;
...
import com.example.thuc_tap_tmdd_fpoly.databinding.ActivityMainBinding;
import com.example.thuc_tap_tmdd_fpoly.fragment.CartFragment;
import com.example.thuc_tap_tmdd_fpoly.fragment.HomeFragment;
import com.example.thuc_tap_tmdd_fpoly.fragment.ProfileFragment;
import com.example.thuc_tap_tmdd_fpoly.fragment.SearchProductFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void requestPermissions() {
        ...
        if (!cameraPermissionGranted || !storagePermissionGranted) {
            ActivityCompat.requestPermissions(MainActivity.this, new String[]{android.Manifest.permission.CAMERA, Manifest.permission.READ_EXTERNAL_STORAGE}, PERMISSION_REQUEST_CODE);
        } else {
